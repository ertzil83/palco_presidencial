...
function transEus(value)
{
	...
	document.getElementById("meal1").textContent="Masailak sandiarekin";
	document.getElementById("meal2").textContent="Izokin eta gazta freskoaren txigortu minia";
	document.getElementById("meal3").textContent="Olibak eta ozpinetakoak";
	document.getElementById("meal4").textContent="Egosiaren humusa, urdai frijituekin";
	document.getElementById("meal5").textContent="Urdaiazpiko kroketa";
	document.getElementById("meal6").textContent="Solomo eta brie txigortua";
	document.getElementById("meal7").textContent="Kukulu eta antxoa entsalada";
	document.getElementById("meal8").textContent="Patatak Mojo Picón saltsarekin";
	document.getElementById("meal9").textContent="Bakailaoa tipularekin";
	document.getElementById("meal10").textContent="Haragi-bolak, haragi zukuarekin";
	document.getElementById("meal11").textContent="Askotariko gaztak";
	document.getElementById("meal12").textContent="Gofio eta banana moussea";
	document.getElementById("meal13").textContent="Txokolatezko intentsua";
...
function transCas()
{
	...
	document.getElementById("meal1").textContent="Carrillera con sandía";
	document.getElementById("meal2").textContent="Mini tosta de salmón y queso fresco";
	document.getElementById("meal3").textContent="Aceitunas y encurtidoss";
	document.getElementById("meal4").textContent="Humus de cocido con torrezno";
	document.getElementById("meal5").textContent="Croqueta de jamón";
	document.getElementById("meal6").textContent="Tosta de lomo y brie";
	document.getElementById("meal7").textContent="Ensalada de cogollos y anchoas";
	document.getElementById("meal8").textContent="Papas con mojo picón";
	document.getElementById("meal9").textContent="Bacalao encebollado";
	document.getElementById("meal10").textContent="Albóndigas con jugo de carne";
	document.getElementById("meal11").textContent="Quesos variados";
	document.getElementById("meal12").textContent="Mousse de gofio y plátano";
	document.getElementById("meal13").textContent="Intenso de chocolate";
	document.getElementById("period_span").textContent = period_es;
