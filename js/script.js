...
function transEus(value)
{
	...
	document.getElementById("meal1").textContent="Coppa kukusoa";
	document.getElementById("meal2").textContent="Txangurro kroketa";
	document.getElementById("meal3").textContent="Hegaluze minia tomatearekin eta piperrekin";
	...
	document.getElementById("meal10").textContent="Kardua ajoarrieroarekin ";
	document.getElementById("meal11").textContent="Zainzuri naturalak saltsa berdean";
	document.getElementById("meal12").textContent="Hautsitako arrautzak odolkiarekin";
	document.getElementById("meal13").textContent="Bakailaoa piper berdearekin";
	document.getElementById("meal14").textContent="Esneko arkumea letxuga entsaladarekin";
	document.getElementById("meal15").textContent="Bost motatako gazta";
	document.getElementById("meal16").textContent="Pestiñoak";
	document.getElementById("meal17").textContent="Profiterolak";
	document.getElementById("meal18").textContent="Txokolate eta hur torradak";
...
function transCas()
{
	...
	document.getElementById("meal1").textContent="Pulga de coppa";
	document.getElementById("meal2").textContent="Croqueta de txangurro";
	document.getElementById("meal3").textContent="Mini de bonito con tomate y piparras";
	...
	document.getElementById("meal10").textContent="Cardo con ajoarriero";
	document.getElementById("meal11").textContent="Espárragos naturales en salsa verde";
	document.getElementById("meal12").textContent="Huevos rotos con morcilla";
	document.getElementById("meal13").textContent="Bacalao con pimiento verde";
	document.getElementById("meal14").textContent="Lechazo con ensalada de lechuga";
	document.getElementById("meal15").textContent="Queso 5 variedades";
	document.getElementById("meal16").textContent="Pestiños";
	document.getElementById("meal17").textContent="Profiteroles";
	document.getElementById("meal18").textContent="Torrijas de chocolate y avellana";
	document.getElementById("period_span").textContent = period_es;
