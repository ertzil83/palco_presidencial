...
function transEus(value)
{
	...
	document.getElementById("meal1").textContent="Urdaiazpiko-kroketa";
	document.getElementById("meal2").textContent="Izokin-kusoa tartariarrarekin";
	document.getElementById("meal3").textContent="Arraigorri entsaladila";
	document.getElementById("meal4").textContent="Ganba nigiria";
	document.getElementById("meal5").textContent="Txuleta eta zaizuri makia";
	...
	document.getElementById("meal9").textContent="Joselito solomoa, saltxitxoia eta lukainka";
	document.getElementById("meal10").textContent="Madrildar eltzekoa bere salda eta estropezuekin";
	document.getElementById("meal11").textContent="Pistoa arrautzarekin";
	document.getElementById("meal12").textContent="Txangurrua, kalabaza eta laranja";
	document.getElementById("meal13").textContent="Bakailaoa piperradarekin";
	document.getElementById("meal14").textContent="Ahate- eta berenjena-terrina";
	document.getElementById("meal15").textContent="Askotariko gaztak";
	document.getElementById("meal16").textContent="Gazta-tarta minia";
	document.getElementById("meal17").textContent="Mamia, eztia eta intxaurrak";
...
function transCas()
{
	...
	document.getElementById("meal1").textContent="Croqueta de jamón";
	document.getElementById("meal2").textContent="Pulga de salmón con tártara ";
	document.getElementById("meal3").textContent="Ensaladilla de arraigorri";
	document.getElementById("meal4").textContent="Nigiri salmón y choricero";
	document.getElementById("meal5").textContent="Nigiri de gamba roja";
	document.getElementById("meal6").textContent="Maki de txuleta y espárrago";
	document.getElementById("meal7").textContent="Maki de merluza y piquillo";
	...
	document.getElementById("meal10").textContent="Cocido Madrileño con su caldo y tropiezos";
	document.getElementById("meal11").textContent="Pisto con huevo a baja";
	document.getElementById("meal12").textContent="Txangurro, calabaza y naranja";
	document.getElementById("meal13").textContent="Bacalao con piperrada";
	document.getElementById("meal14").textContent="Terrina de pato y berenjena";
	document.getElementById("meal15").textContent="Quesos variados";
	document.getElementById("meal16").textContent="Mini tarta de queso";
	document.getElementById("meal17").textContent="Cuajada, miel y nueces";
