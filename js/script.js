...
function transEus(value)
{
	...
	document.getElementById("meal1").textContent="Kopa-arkakusoa";
	document.getElementById("meal2").textContent="Arrautza eta ganbazko pintxoa";
	document.getElementById("meal3").textContent="Antxoa eta piperminezko gilda klasikoa";
	document.getElementById("meal4").textContent="Urdaiazpiko kroketa";
	document.getElementById("meal5").textContent="Txistorra-taloa eta patata errea";
	document.getElementById("meal6").textContent="Mixto trufatua";
	document.getElementById("meal7").textContent="Foiea plantxan sagar-purearekin";
	document.getElementById("meal8").textContent="Patata frijituak eta fruitu lehorrak";
	document.getElementById("meal9").textContent="Ozpinetakoak eta txokolatinak";
	document.getElementById("meal10").textContent="Askotariko donuts, macarons eta pastak";
	document.getElementById("meal11").textContent="Askotariko gaztak";
	document.getElementById("meal12").textContent="Minipantxineta";
...
function transCas()
{
	...
	document.getElementById("meal1").textContent="Pulga de copa";
	document.getElementById("meal2").textContent="Pintxo tradicional de huevo y gamba";
	document.getElementById("meal3").textContent="Gilda clásica de antxoa y guindilla";
	document.getElementById("meal4").textContent="Croqueta de jamón-jamón";
	document.getElementById("meal5").textContent="Talo de txistorra y patata asada";
	document.getElementById("meal6").textContent="Mixto trufado";
	document.getElementById("meal7").textContent="Foie a la plancha con puré de manzana asada";
	document.getElementById("meal8").textContent="Patatas fritas y frutos secos";
	document.getElementById("meal9").textContent="Encurtidos y chocolatinas";
	document.getElementById("meal10").textContent="Donuts, Macarons y pastas variadas";
