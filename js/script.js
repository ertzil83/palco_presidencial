...
function transEus(value)
{
	...
	document.getElementById("meal1").textContent="Arrautza eta ganbazko klasiko donostiarra";
	document.getElementById("meal2").textContent="Solomo eta brie karamelua";
	document.getElementById("meal3").textContent="Misto trufatua";
	document.getElementById("meal4").textContent="Txuleta nigiria";
	document.getElementById("meal5").textContent="Ganba gorri nigiria";
	document.getElementById("meal6").textContent="Txipiroia tintan nigiria";
	document.getElementById("meal7").textContent="Bieira makia, Idiazabalekin";
	document.getElementById("meal8").textContent="Joselito erreserba handiko urdaiazpikoa";
	document.getElementById("meal9").textContent="Joselito solomoa, lukainka eta txorizoa";
	document.getElementById("meal10").textContent="Orburuak saltsa berdean";
	document.getElementById("meal11").textContent="Txerri-hankak eta txitxirioak";
	document.getElementById("meal12").textContent="Bakailao kokotxak, txorizeroen saltsarekin";
	document.getElementById("meal13").textContent="Izokina eta onddo kontsomea";
	//document.getElementById("meal14").textContent="Itsas zapo errea eta moluskuen zukua";
	document.getElementById("meal15").textContent="5 motatako gazta";
	document.getElementById("meal16").textContent="Melokotoia eta jogurta";
	document.getElementById("meal17").textContent="Gorringo txigortuzko eta glasatuzko bizkotxoa";
	//document.getElementById("meal18").textContent="Hostopila";
...
function transCas()
{
	...
	document.getElementById("meal1").textContent="Clásico donostiarra de huevo y gamba";
	document.getElementById("meal2").textContent="Caramelo de lomo y brie";
	document.getElementById("meal3").textContent="Mixto trufado";
	document.getElementById("meal4").textContent="Nigiri de txuleta";
	document.getElementById("meal5").textContent="Nigiri gamba roja";
	document.getElementById("meal6").textContent="Maki de txipirón en tinta";
	...
	document.getElementById("meal9").textContent="Lomo, salchichón y longaniza Joselito";
	document.getElementById("meal10").textContent="Alcachofas en salsa verde";
	document.getElementById("meal11").textContent="Manitas y garbanzos";
	document.getElementById("meal12").textContent="Kokotxas de bacalao con salsa de choriceros";
	document.getElementById("meal13").textContent="Salmón y consomé de hongo";
	//document.getElementById("meal14").textContent="Rape asado y jugo de moluscos";
	document.getElementById("meal15").textContent="Queso 5 variedades";
	document.getElementById("meal16").textContent="Melocoton y yogurt";
	document.getElementById("meal17").textContent="Bizcocho de yema tostada y glaseado";
	//document.getElementById("meal18").textContent="Milhojas de hojaldre";
	document.getElementById("period_span").textContent = period_es;
