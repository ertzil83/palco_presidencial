...
function transEus(value)
{
	...
	document.getElementById("meal1").textContent="Gilda oliba";
	document.getElementById("meal2").textContent="Zainzuri zuri moussea perrexil gelarekin";
	document.getElementById("meal3").textContent="Coppa kukusoa";
	...
	document.getElementById("meal10").textContent="Orburua, hezur muina eta Lumagorria";
	document.getElementById("meal11").textContent="Perretxiko eta haragi zuku arroza";
	document.getElementById("meal12").textContent="Zapoa izkiratzar saltsan";
	document.getElementById("meal13").textContent="Haragi bola tomateztatuak";
	document.getElementById("meal14").textContent="Uso gisatua eta topinanbu purea";
	document.getElementById("meal15").textContent="Bost motatako gazta";
	document.getElementById("meal16").textContent="Txokolate kurruskaria";
...
function transCas()
{
	...
	document.getElementById("meal1").textContent="Aceituna de gilda";
	document.getElementById("meal2").textContent="Mousse de espárragos blancos con gel de perejil";
	document.getElementById("meal3").textContent="Pulga de coppa";
	...
	document.getElementById("meal11").textContent="Arroz de setas y jugo de carne";
	document.getElementById("meal12").textContent="Rape en salsa de carabineros";
	document.getElementById("meal13").textContent="Albóndigas atomatadas";
	document.getElementById("meal14").textContent="Paloma guisada y puré de topinambur";
	document.getElementById("meal15").textContent="Queso 5 variedades";
	document.getElementById("meal16").textContent="Crujiente de chocolate";
