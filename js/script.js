...
function transEus(value)
{
	...
	document.getElementById("meal1").textContent="Hegaluzea maionesarekin";
	document.getElementById("meal2").textContent="Patata-tortilla";
	document.getElementById("meal3").textContent="Askotariko gozoak";
	document.getElementById("meal4").textContent="Egosiaren humusa, urdai frijituekin";
	document.getElementById("meal5").textContent="Hostopila, foie eta sagarra";
	document.getElementById("meal6").textContent="Ajoarrierozko kroketak";
	document.getElementById("meal7").textContent="Ilarrak udaberriko zaizuriekin";
	document.getElementById("meal8").textContent="Izkiratzar arroza";
	document.getElementById("meal9").textContent="Arrain zuria, saltsa berdean";
	document.getElementById("meal10").textContent="Haragizko lasagna";
	document.getElementById("meal11").textContent="Askotariko gaztak";
	document.getElementById("meal12").textContent="Merengea";
	document.getElementById("meal13").textContent="Mamia eztiarekin";
...
function transCas()
{
	...
	document.getElementById("meal1").textContent="Bonito con mahonesa";
	document.getElementById("meal2").textContent="Tortilla de patata";
	document.getElementById("meal3").textContent="Dulces variados";
	document.getElementById("meal4").textContent="Humus de cocido con torrezno";
	document.getElementById("meal5").textContent="Hojaldre, foie y manzana";
	document.getElementById("meal6").textContent="Croqueta de ajoarriero";
	document.getElementById("meal7").textContent="Guisantes con espárragos de primavera";
	document.getElementById("meal8").textContent="Arroz de carabinero";
	document.getElementById("meal9").textContent="Pescado blanco en salsa verde";
	document.getElementById("meal10").textContent="Lasagna de carne";
	document.getElementById("meal11").textContent="Quesos variados";
	document.getElementById("meal12").textContent="Merengue";
	document.getElementById("meal13").textContent="Mamia con miel";
	document.getElementById("period_span").textContent = period_es;
