...
function transEus(value)
{
	...
	document.getElementById("meal1").textContent="Arabako patataz eginiko tortilla";
	document.getElementById("meal2").textContent="Hegaluze, antxoa eta piparra kukusua";
	document.getElementById("meal3").textContent="Foie eta tomate errea";
	document.getElementById("meal4").textContent="Izokin Nigiria";
	document.getElementById("meal5").textContent="Ganba gorri Nigiria";
	document.getElementById("meal6").textContent="Txangurro tenpurizatu Makia";
	...
	document.getElementById("meal9").textContent="Joselito solomo, lukainka eta txorizoa";
	document.getElementById("meal10").textContent="Tenperatura baxuan eginiko arrautzadun pistoa";
	document.getElementById("meal11").textContent="Semola txahalarekin";
	document.getElementById("meal12").textContent="Legatz erregosia";
	document.getElementById("meal13").textContent="Papada potxekin";
	...
	document.getElementById("meal16").textContent="Laranja eta azahar zopa";
	document.getElementById("meal17").textContent="Sagar errea";
	document.getElementById("meal18").textContent="Euskal pastela";
...
function transCas()
{
	...
	document.getElementById("meal1").textContent="Tortilla de patata Alavesa";
	document.getElementById("meal2").textContent="Pulga de bonito antxoas y piparras";
	document.getElementById("meal3").textContent="Foie y tomate asado";
	document.getElementById("meal4").textContent="Nigiri de salmón";
	document.getElementById("meal5").textContent="Nigiri de gamba roja";
	document.getElementById("meal6").textContent="Maki tempurizado de txangurro";
	...
	document.getElementById("meal9").textContent="Lomo, longaniza y chorizo Joselito";
	document.getElementById("meal10").textContent="Pisto con huevo a temperatura baja";
	document.getElementById("meal11").textContent="Sémola con ternera";
	document.getElementById("meal12").textContent="Merluza rebozada";
	document.getElementById("meal13").textContent="Papada con pochas";
	...
	document.getElementById("meal17").textContent="Manzana asada";
	document.getElementById("meal18").textContent="Pastel vasco";
	document.getElementById("period_span").textContent = period_es;
