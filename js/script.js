...
function transEus(value)
{
	...
	document.getElementById("meal1").textContent="Solomo eta brie gaztaren kukusoa";
	document.getElementById("meal2").textContent="Foiea mahatsarekin";
	document.getElementById("meal3").textContent="Bakailao tortilla";
	document.getElementById("meal4").textContent="Izokin nigiria";
	document.getElementById("meal5").textContent="Ganba gorri nigiria";
	document.getElementById("meal6").textContent="Bieira makia Idiazabal gaztarekin";
	document.getElementById("meal7").textContent="Legatz frijitu eta pikillo makia";
	document.getElementById("meal8").textContent="Joselito erreserba handiko urdaiazpikoa";
	document.getElementById("meal9").textContent="Joselito solomoa, saltxitxoia eta kopa";
	document.getElementById("meal10").textContent="Txangurru, porru eta legatz lasagna";
	document.getElementById("meal11").textContent="Ilarrak, patata eta zainzuriak saltsa berdean";
	document.getElementById("meal12").textContent="Odolki nahaskia piper konfitatuekin";
	document.getElementById("meal13").textContent="Legatza saltsa berdean";
	document.getElementById("meal14").textContent="Arkumea, letxuga eta tipula";
	document.getElementById("meal15").textContent="Bost motatako gazta";
	document.getElementById("meal16").textContent="Mamia eztiarekin";
	document.getElementById("meal17").textContent="Txokolatezko moussea eta kafezko krematsua kurruskariarekin";
...
function transCas()
{
	...
	document.getElementById("meal1").textContent="Pulga de lomo y queso brie";
	document.getElementById("meal2").textContent="Foie con uvas";
	document.getElementById("meal3").textContent="Tortilla de bacalao";
	document.getElementById("meal4").textContent="Nigiri salmón";
	document.getElementById("meal5").textContent="Nigiri gamba roja";
	document.getElementById("meal6").textContent="Maki de vieira con Idiazabal";
	document.getElementById("meal7").textContent="Maki de merluza frita y pikillo";
	document.getElementById("meal8").textContent="Jamón gran reserva Joselito";
	document.getElementById("meal9").textContent="Lomo, salchichón y copa Joselito";
	document.getElementById("meal10").textContent="Lasaña de txangurro, puerro y merluza";
	document.getElementById("meal11").textContent="Guisantes, patata y espárragos en salsa verde";
	document.getElementById("meal12").textContent="Revuelto de morcilla con pimientos confitados";
	document.getElementById("meal13").textContent="Merluza con salsa verde";
	document.getElementById("meal14").textContent="Cordero, lechuga y cebolla";
	document.getElementById("meal15").textContent="Queso 5 variedades";
	document.getElementById("meal16").textContent="Mamía con miel";
	document.getElementById("meal17").textContent="Mousse de chocolate y cremoso de café con crujiente";
