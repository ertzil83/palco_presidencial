...
function transEus(value)
{
	...
	document.getElementById("meal1").textContent="Ahuakate eta gazta freskoa txigorkian";
	document.getElementById("meal2").textContent="Izokin eta onddo croissanta";
	document.getElementById("meal3").textContent="Urdaiazpiko eta gazta medianotxea";
	document.getElementById("meal4").textContent="Porru terrina zuku epelarekin";
	document.getElementById("meal5").textContent="Haragi-lasagna";
	document.getElementById("meal6").textContent="Mangozko gorringoa kanela zopan";
	document.getElementById("meal7").textContent="Txokolatea";
	document.getElementById("meal8").textContent="Almendra-pralina eta kurruskaria";
	document.getElementById("meal9").textContent="Sagar tarta";
	document.getElementById("meal10").textContent="";
	document.getElementById("meal11").textContent="Askotariko gaztak";
	document.getElementById("meal12").textContent="Txokolatezko moussea eta kafezko bavaroisa";
	document.getElementById("meal13").textContent="Mini pantxineta";
...
function transCas()
{
	...
	document.getElementById("meal1").textContent="Tosta de aguacate y queso fresco";
	document.getElementById("meal2").textContent="Croissant de salmón y hongos";
	document.getElementById("meal3").textContent="Media noche de jamón y queso";
	document.getElementById("meal4").textContent="Terrina de puerros con jugo tibio";
	document.getElementById("meal5").textContent="Lasagna de carne";
	document.getElementById("meal6").textContent="Yema de mango en sopa de canela";
	document.getElementById("meal7").textContent="Chocolate";
	document.getElementById("meal8").textContent="Praliné de almendra y crujiente";
	document.getElementById("meal9").textContent="Tartita de manzana";
	document.getElementById("meal10").textContent="";
	document.getElementById("meal11").textContent="Quesos variados";
	document.getElementById("meal12").textContent="Mousse de chocolate y bavaroise de café";
	document.getElementById("meal13").textContent="Mini pantxineta";
	document.getElementById("period_span").textContent = period_es;
