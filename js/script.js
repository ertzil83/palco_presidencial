...
function transEus(value)
{
	...
	document.getElementById("meal1").textContent="Tartar iberikoa eta pikilloa ";
	document.getElementById("meal2").textContent="Pikuak foierekin";
	document.getElementById("meal3").textContent="Txistorra kukusoa";
	...
	document.getElementById("meal10").textContent="Zerba eta anakardoa";
	document.getElementById("meal11").textContent="Tipula eta gazta zopa";
	document.getElementById("meal12").textContent="Txangurrozko pistoa";
	document.getElementById("meal13").textContent="Lepapea potxekin";
	document.getElementById("meal14").textContent="Txipiroiak tintan, arrozarekin";
	document.getElementById("meal15").textContent="5 motatako gaztak";
	document.getElementById("meal16").textContent="Laranja-lore eta banillazko natilla";
	document.getElementById("meal17").textContent="Mamia eztiarekin";
	document.getElementById("meal18").textContent="Mini pantxineta";
...
function transCas()
{
	...
	document.getElementById("meal1").textContent="Tartar ibérico y pikillo";
	document.getElementById("meal2").textContent="Higos con foie";
	document.getElementById("meal3").textContent="Pulga de txistorra";
	...
	document.getElementById("meal10").textContent="Acelga y anacardo";
	document.getElementById("meal11").textContent="Sopa de cebolla y queso";
	document.getElementById("meal12").textContent="Pisto de txangurro";
	document.getElementById("meal13").textContent="Papada con pochas";
	document.getElementById("meal14").textContent="Txipirones en tinta con arroz ";
	document.getElementById("meal15").textContent="Queso 5 variedades";
	document.getElementById("meal16").textContent="Natillas de azahar y vainilla";
	document.getElementById("meal17").textContent="Mamia con miel";
	document.getElementById("meal18").textContent="Minipantxineta";
	document.getElementById("period_span").textContent = period_es;
