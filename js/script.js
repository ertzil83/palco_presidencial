...
function transEus(value)
{
	...
	document.getElementById("meal1").textContent="Onddo meta";
	document.getElementById("meal2").textContent="Paseo berriko arrokak";
	document.getElementById("meal3").textContent="Hegaluzea eta ozpinetako gereziak";
	document.getElementById("meal4").textContent="Izokin Nigiria";
	document.getElementById("meal5").textContent="Txuleta Nigiria";
	document.getElementById("meal6").textContent="Legatz frijitu eta pikillo Makia";
	document.getElementById("meal7").textContent="Idiazabaldun bieira Makia";
	document.getElementById("meal8").textContent="Joselito erreserba handiko urdaiazpikoa";
	document.getElementById("meal9").textContent="Joselito kopa, saltxitxoia eta txorizoa";
	document.getElementById("meal10").textContent="Piper saldadun tenperatura baxuko arrautzak eta arroz fideoak";
	document.getElementById("meal11").textContent="Tipula eta gazta zopa";
	document.getElementById("meal12").textContent="Bieira zarakartua eta hegazti-zukua";
	document.getElementById("meal13").textContent="Arrain zuria saltsa verdean";
	...
	document.getElementById("meal16").textContent="Arroz esnea eta mangoa";
	document.getElementById("meal17").textContent="Anana eta txokolatezko flan hautsia";
	document.getElementById("meal18").textContent="Laranja merengea";
...
function transCas()
{
	...
	document.getElementById("meal1").textContent="Meta de hongos";
	document.getElementById("meal2").textContent="Las rocas del paseo nuevo";
	document.getElementById("meal3").textContent="Bonito y cerezas encurtidas";
	document.getElementById("meal4").textContent="Nigiri de salmón";
	document.getElementById("meal5").textContent="Nigiri de gamba roja";
	...
	document.getElementById("meal9").textContent="Copa, salchichón y chorizo Joselito";
	document.getElementById("meal10").textContent="Huevo a baja con caldo de pimientos y fideos de arroz";
	document.getElementById("meal11").textContent="Sopa de cebolla y queso";
	document.getElementById("meal12").textContent="Vieira costrada y jugo de ave";
	document.getElementById("meal13").textContent="Pescado blanco en salsa verde";
	...
	document.getElementById("meal16").textContent="Arroz con leche y mango";
	document.getElementById("meal17").textContent="Flan roto de piña y chocolate";
	document.getElementById("meal18").textContent="Merengue de naranja";
	document.getElementById("period_span").textContent = period_es;
