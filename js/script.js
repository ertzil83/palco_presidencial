...
function transEus(value)
{
	...
	document.getElementById("meal1").textContent="Hegalabur kukusoa";
	document.getElementById("meal2").textContent="Fuet platertxoa";
	document.getElementById("meal3").textContent="Urdaiazpiko kroketa";
	document.getElementById("meal4").textContent="Gabardina ganba";
	document.getElementById("meal5").textContent="Odolkia, sagar purearekin";
	document.getElementById("meal6").textContent="Lumagorri eta artoa";
	document.getElementById("meal7").textContent="Piltzarra";
	document.getElementById("meal8").textContent="Entsalada valentziarra";
	document.getElementById("meal9").textContent="Txangurroz betetako piperra";
	document.getElementById("meal10").textContent="Itsas-zapoa saltsan";
	document.getElementById("meal11").textContent="Hostopilak";
	document.getElementById("meal12").textContent="Askotariko txokolateak";
	document.getElementById("meal13").textContent="";
...
function transCas()
{
	...
	document.getElementById("meal1").textContent="Pulga de atún";
	document.getElementById("meal2").textContent="Platito de fuet";
	document.getElementById("meal3").textContent="Croqueta de jamón";
	document.getElementById("meal4").textContent="Gamba gabardina";
	document.getElementById("meal5").textContent="Morcilla con puré de manzana";
	document.getElementById("meal6").textContent="Lumagorri y maíz";
	document.getElementById("meal7").textContent="Ropa vieja";
	document.getElementById("meal8").textContent="Ensalada valenciana";
	document.getElementById("meal9").textContent="Pimiento relleno de txangurro";
	document.getElementById("meal10").textContent="Rape en salsa";
	document.getElementById("meal11").textContent="Hojaldres";
	document.getElementById("meal12").textContent="Chocolates variados";
	document.getElementById("meal13").textContent="";
	document.getElementById("period_span").textContent = period_es;
