...
function transEus(value)
{
	...
	document.getElementById("meal1").textContent="Izokin eta onddo croissanta";
	document.getElementById("meal2").textContent="Sukaldean bakailao tortilla";
	document.getElementById("meal3").textContent="Gilda azeituna";
	document.getElementById("meal4").textContent="Izokin nigiria";
	document.getElementById("meal5").textContent="Bokado Rolla";
	document.getElementById("meal6").textContent="Txangurrozko tenpurizatutako makia";
	...
	document.getElementById("meal10").textContent="Perretxiko eta haragi zukudun arroza";
	document.getElementById("meal11").textContent="Paparra potxekin";
	document.getElementById("meal12").textContent="Zapoa, onddo mojoa eta gorringoa";
	document.getElementById("meal13").textContent="Iberikoaren saiheski konfitatua eta hezur gabetua, bere zukuarekin";
	document.getElementById("meal14").textContent="Lumagorri raviolia eta barazkiak";
	document.getElementById("meal15").textContent="5 motatako gazta";
	document.getElementById("meal16").textContent="Torradak ur txigortuarekin";
	document.getElementById("meal17").textContent="Txokolatea, almendra pralinea eta kurruskaria";
	//document.getElementById("meal18").textContent="Pina errezko euskal pastiza";
...
function transCas()
{
	...
	document.getElementById("meal1").textContent="Croissant de Salmón y Hongos";
	document.getElementById("meal2").textContent="Tortilla de bacalao Sukaldean";
	document.getElementById("meal3").textContent="Aceituna de gilda";
	document.getElementById("meal4").textContent="Nigiri salmón";
	document.getElementById("meal5").textContent="Bokado Roll";
	...
	document.getElementById("meal10").textContent="Arroz de setas y jugo de carne";
	document.getElementById("meal11").textContent="Papada con pochas";
	document.getElementById("meal12").textContent="Rape, mojo de hongos y yema";
	document.getElementById("meal13").textContent="Costillar de ibérico confitado y deshuesado con su jugo";
	document.getElementById("meal14").textContent="Ravioli de Lumagorri y hortalizas";
	document.getElementById("meal15").textContent="Queso 5 variedades";
	document.getElementById("meal16").textContent="Torrijas con avellana tostada";
	document.getElementById("meal17").textContent="Chocolate, praliné de almendra y crujiente";
