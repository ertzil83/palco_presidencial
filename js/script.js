...
function transEus(value)
{
	...
	document.getElementById("meal1").textContent="Hegaluze kukusoa maionesarekin";
	document.getElementById("meal2").textContent="Donostiar erako txangurroa";
	document.getElementById("meal3").textContent="Lumagorri eta mugurdi patea";
	document.getElementById("meal4").textContent="Izokin nigiria";
	document.getElementById("meal5").textContent="Roll mokadua";
	...
	document.getElementById("meal10").textContent="Opiltxoak esne-gain eta txokolatearekin";
	document.getElementById("meal11").textContent="Antxoa eta gazpatxo lasagna";
	document.getElementById("meal12").textContent="Txipiroiak bere tintan arrozarekin";
	document.getElementById("meal13").textContent="Iberiar azpizuna bere zukuan eta patatazko pure krematsua";
	//document.getElementById("meal14").textContent="Ahatea alberjiniarekin";
	document.getElementById("meal15").textContent="Bost motatako gazta";
	document.getElementById("meal16").textContent="Anana eta txokolatezko flan hautsia";
	document.getElementById("meal17").textContent="Rubi eta hur txokolatea";
	document.getElementById("meal18").textContent="Kanela eta arroz-esnea";
...
function transCas()
{
	...
	document.getElementById("meal2").textContent="Txangurro a la Donostiarra";
	document.getElementById("meal3").textContent="Pate de lumagorri y frambuesa";
	...
	document.getElementById("meal10").textContent="Tortitas con nata y chocolate";
	document.getElementById("meal11").textContent="Lasagna de antxoas y gazpacho";
	document.getElementById("meal12").textContent="Txipirones en su tinta con arroz";
	document.getElementById("meal13").textContent="Solomillo de ibérico con su jugo y cremoso de patata";
	//document.getElementById("meal14").textContent="Pato con berenjena";
	document.getElementById("meal15").textContent="Queso 5 variedades";
	document.getElementById("meal16").textContent="Flan roto de piña y chocolate";
	document.getElementById("meal17").textContent="Chocolate Rubí y avellana";
	document.getElementById("meal18").textContent="Canela y arroz con leche";
	document.getElementById("period_span").textContent = period_es;
