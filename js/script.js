...
function transEus(value)
{
	...
	document.getElementById("meal1").textContent="Txorizo kukusoa";
	document.getElementById("meal2").textContent="Onddo kroketa";
	document.getElementById("meal3").textContent="Txingarren Vol au venta tomatearekin";
	document.getElementById("meal4").textContent="Mini burgerra";
	document.getElementById("meal5").textContent="Patata eta tipulazko tortilla";
	document.getElementById("meal6").textContent="Pasta entsalada";
	document.getElementById("meal7").textContent="Porrusalda krema, haragi zuku eta bainilarekin";
	document.getElementById("meal8").textContent="Otarrainxkak, arabar-errioxarrean erregositako txanpinoiekin";
	document.getElementById("meal9").textContent="Txekorra tenperatura baxuan, patatazko pure krematsuarekin";
	document.getElementById("meal10").textContent="Askotariko hostopilak";
	document.getElementById("meal11").textContent="Kakaozko natilak";
	document.getElementById("meal12").textContent="Limoizko souflea";
...
function transCas()
{
	...
	document.getElementById("meal1").textContent="Pulga de chorizo";
	document.getElementById("meal2").textContent="Croqueta de hongos";
	document.getElementById("meal3").textContent="Vol au vent de magras con tomate";
	document.getElementById("meal4").textContent="Mini burguer";
	document.getElementById("meal5").textContent="Tortilla de patata y cebolla";
	document.getElementById("meal6").textContent="Ensalada de pasta";
	document.getElementById("meal7").textContent="Crema de porrusalda con jugo de carne y vainilla";
	document.getElementById("meal8").textContent="Langostinos con champignones braseados al rioja alavesa";
	document.getElementById("meal9").textContent="Ternera a baja temperatura con puré cremoso de patata";
	document.getElementById("meal10").textContent="Hojaldres variados";
	document.getElementById("meal11").textContent="Natillas de cacao";
	document.getElementById("meal12").textContent="Souflé de limón";
