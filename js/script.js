...
function transEus(value)
{
	...
	document.getElementById("meal1").textContent="Kopa kukusoa";
	document.getElementById("meal2").textContent="Saltxitxa eta aza";
	document.getElementById("meal3").textContent="Gazta krema eta muskuilu eskabetxatua txigortuan";
	document.getElementById("meal4").textContent="Izokin eta txorizero nigiria";
	document.getElementById("meal5").textContent="Bieira nigiria";
	document.getElementById("meal6").textContent="Txuleta eta pikillo makia";
	...
	document.getElementById("meal10").textContent="Arraingorri eta ganben entsaladilla";
...
function transCas()
{
	...
	document.getElementById("meal2").textContent="Salchicha y berza";
	document.getElementById("meal3").textContent="Tostada de queso crema y mejillón escabechado";
	document.getElementById("meal4").textContent="Nigiri salmón y choricero";
	document.getElementById("meal5").textContent="Nigiri de vieira";
	document.getElementById("meal6").textContent="Maki de Txuleta y pikillo";
	...
	document.getElementById("meal10").textContent="Ensaladilla de arraigorri y gamba ";
