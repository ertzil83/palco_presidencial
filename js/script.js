...
function transEus(value)
{
	...
	document.getElementById("meal1").textContent="Bakailao tortilla kukusoa";
	document.getElementById("meal2").textContent="Gilda klasikoa";
	document.getElementById("meal3").textContent="Saltsa berdedun txirla kroketa";
	document.getElementById("meal4").textContent="Izokin nigiria";
	document.getElementById("meal5").textContent="Vieira nigiria";
	document.getElementById("meal6").textContent="Txipiroi makia bere tintan";
	document.getElementById("meal7").textContent="Legatz eta pikillo makia";
	...
	document.getElementById("meal10").textContent="Salmorejoa ";
	document.getElementById("meal11").textContent="Garbantzuak, espinakak eta foiea";
	document.getElementById("meal12").textContent="Papak txokoekin";
	document.getElementById("meal13").textContent="Presa iberiko errea";
	document.getElementById("meal14").textContent="Zezen buztana lasto patatekin";
	document.getElementById("meal15").textContent="Bost motatako gazta";
	document.getElementById("meal16").textContent="Mini pantxineta";
...
function transCas()
{
	...
	document.getElementById("meal1").textContent="Pulga de tortilla de bacalao";
	document.getElementById("meal2").textContent="Gilda clásica";
	document.getElementById("meal3").textContent="Croqueta de almeja en salsa verde";
	document.getElementById("meal4").textContent="Nigiri salmón";
	document.getElementById("meal5").textContent="Niguiri de vieira";
	document.getElementById("meal6").textContent="Maki de txipirón en su tinta";
	document.getElementById("meal7").textContent="Maki de Merluza y pikillo";
	...
	document.getElementById("meal10").textContent="Salmorejo";
	document.getElementById("meal11").textContent="Garbanzos, espinacas y foie";
	document.getElementById("meal12").textContent="Papas con chocos";
	document.getElementById("meal13").textContent="Presa ibérica asada";
	document.getElementById("meal14").textContent="Rabo de toro con patatas paja";
