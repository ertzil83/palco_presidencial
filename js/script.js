...
function transEus(value)
{
	...
	document.getElementById("meal1").textContent="Hegaluze kukusoa piperminarekin";
	document.getElementById("meal2").textContent="Muskuilu kruxpeta";
	document.getElementById("meal3").textContent="Arraigorri eta ganba gorri entsalada";
	...
	document.getElementById("meal10").textContent="Tzatzikia";
	document.getElementById("meal11").textContent="Arzak pintxoa";
	document.getElementById("meal12").textContent="Orburua, hezur muina eta Lumagorria";
	document.getElementById("meal13").textContent="Legatz arrautzaztatua, entsaladarekin";
	document.getElementById("meal14").textContent="Txahalki salteatua patatekin eta bere saltsarekin";
	document.getElementById("meal15").textContent="Bost motatako gazta";
	document.getElementById("meal16").textContent="Euskal pastela anana errearekin";
...
function transCas()
{
	...
	document.getElementById("meal1").textContent="Pulga de bonito con guindilla";
	document.getElementById("meal2").textContent="Buñuelo de mejillón";
	document.getElementById("meal3").textContent="Ensaladilla de arraigorri y gamba roja";
	...
	document.getElementById("meal10").textContent="Tzatziki";
	document.getElementById("meal11").textContent="Pintxo Arzak";
	document.getElementById("meal12").textContent="Alcachofa, tuétano y Lumagorri";
	document.getElementById("meal13").textContent="Merluza rebozada con ensalada";
	document.getElementById("meal14").textContent="Ternera salteada con patatas y su jugo";
	document.getElementById("meal15").textContent="Queso 5 variedades";
	document.getElementById("meal16").textContent="Gateau basque de piña asada";
