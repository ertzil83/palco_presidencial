...
function transEus(value)
{
	...
	document.getElementById("meal3").textContent="Askotariko gozokiak";
	document.getElementById("meal4").textContent="Muskuilu kroketa";
	document.getElementById("meal5").textContent="Gelba adoboan";
	document.getElementById("meal6").textContent="Txistorra";
	document.getElementById("meal7").textContent="Salmorejoa";
	document.getElementById("meal8").textContent="Cadizko pimentada bakailaoarekin";
	document.getElementById("meal9").textContent="Papak txokoarekin";
	document.getElementById("meal10").textContent="Ehizaki errea boniato purearekin";
	document.getElementById("meal11").textContent="Askotariko gaztak";
	document.getElementById("meal12").textContent="Arroz-esnea";
	document.getElementById("meal13").textContent="Tiramisua";
...
function transCas()
{
	...
	document.getElementById("meal4").textContent="Croqueta de mejillón";
	document.getElementById("meal5").textContent="Cazón en adobo";
	document.getElementById("meal6").textContent="Txistorra";
	document.getElementById("meal7").textContent="Salmorejo";
	document.getElementById("meal8").textContent="Pimentada de Cádiz con bacalao";
	document.getElementById("meal9").textContent="Papas con choco";
	document.getElementById("meal10").textContent="Presa asada con puré de boniato";
	document.getElementById("meal11").textContent="Quesos variados";
	document.getElementById("meal12").textContent="Arroz con leche";
	document.getElementById("meal13").textContent="Tiramisú";
	document.getElementById("period_span").textContent = period_es;
