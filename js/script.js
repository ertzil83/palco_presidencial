...
function transEus(value)
{
	...
	document.getElementById("meal1").textContent="Donuts klasikoak";
	document.getElementById("meal2").textContent="Macaronak";
	document.getElementById("meal3").textContent="Te-pastak";
	document.getElementById("meal4").textContent="Patata-tortilla pintxoa";
	document.getElementById("meal5").textContent="Solomo iberikoko arkakuso kristalinoa";
	document.getElementById("meal6").textContent="York urdaiazpiko eta gazta minia";
	...
	//document.getElementById("meal9").textContent="Joselito solomoa, butifarra eta lukainka";
	document.getElementById("meal10").textContent="Semola lodia entsaladan";
	document.getElementById("meal11").textContent="Euskaltxerri albondigak tomatearekin";
	//document.getElementById("meal12").textContent="Txangurroa, kuia eta laranja";
	//document.getElementById("meal13").textContent="Zapoa, saltsa berdean";
	//document.getElementById("meal14").textContent="Azpizuna, topinanbu eta kafea";
	document.getElementById("meal15").textContent="Askotariko gaztak";
	document.getElementById("meal16").textContent="Txokolatezko pastela";
	document.getElementById("meal17").textContent="Pantxineta txikia";
	//document.getElementById("meal18").textContent="Mango gorringoa, kanela zopan";
...
function transCas()
{
	...
	document.getElementById("meal1").textContent="Donuts clásicos";
	document.getElementById("meal2").textContent="Macarons";
	document.getElementById("meal3").textContent="Pastas de té";
	document.getElementById("meal4").textContent="Pintxo de tortilla de patata";
	document.getElementById("meal5").textContent="Pulga cristalina de lomo ibérico";
	document.getElementById("meal6").textContent="Mini de jamón york-queso";
	...
	//document.getElementById("meal9").textContent="Lomo, butifarra y longaniza Joselito";
	document.getElementById("meal10").textContent="Sémola gruesa en ensalada";
	document.getElementById("meal11").textContent="Albóndigas de euskaltxerri atomatada";
	//document.getElementById("meal12").textContent="Txangurro, calabaza y naranja";
	//document.getElementById("meal13").textContent="Rape en salsa verde";
	//document.getElementById("meal14").textContent="Solomillo topinambour y café";
	document.getElementById("meal15").textContent="Quesos variados";
	document.getElementById("meal16").textContent="Pastel de chocolate";
	document.getElementById("meal17").textContent="Mini pantxineta";
	//document.getElementById("meal18").textContent="Yema de mando en sopa de canela";
	document.getElementById("period_span").textContent = period_es;
