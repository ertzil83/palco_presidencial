...
function transEus(value)
{
	...
	document.getElementById("meal1").textContent="Pringá kukusoa";
	document.getElementById("meal2").textContent="Foie sagar errearen purearekin";
	...
	document.getElementById("meal11").textContent="Orburua, lumagorri eta gorringoa";
	document.getElementById("meal12").textContent="Ilarrak, patata eta zainzuriak saltsa berdean";
	document.getElementById("meal13").textContent="Arandoia, ardi esnea eta lihoa";
	...
	document.getElementById("meal17").textContent="Marrubiak, jogurta eta hibiskusa";
...
function transCas()
{
	...
	document.getElementById("meal1").textContent="Pulga de pringá";
	document.getElementById("meal2").textContent="Foie con pure de manzana asada";
	...
	document.getElementById("meal11").textContent="Alcachofa, lumagorri y yema";
	document.getElementById("meal12").textContent="Guisantes, patata y espárragos en salsa verde";
	document.getElementById("meal13").textContent="Molleja, leche de oveja y lino";
	...
	document.getElementById("meal17").textContent="Fresas, yogur e hibiscus";
