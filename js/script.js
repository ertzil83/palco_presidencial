...
function transEus(value)
{
	...
	document.getElementById("meal1").textContent="Tartara  “la vaca que ríe”n";
	document.getElementById("meal2").textContent="Gazpatxoa";
	document.getElementById("meal3").textContent="Solomo eta brie kukusoa";
	document.getElementById("meal4").textContent="Izokin Nigiria";
	document.getElementById("meal5").textContent="Txuleta Nigiria";
	document.getElementById("meal6").textContent="Legatz makia frijitua eta pikilloa ";
	document.getElementById("meal7").textContent="Txangurrozko tenpurizatutako makia";
	...
	document.getElementById("meal10").textContent="Txangurroz betetako piperrak";
	document.getElementById("meal11").textContent="Eskabetxe muskuilua eta porrua";
	document.getElementById("meal12").textContent="Eper raviolia eta barazkiak";
	document.getElementById("meal13").textContent="Zapoa, perrexila eta bere olio errearen emultsioa";
	//document.getElementById("meal14").textContent="Konfitatu eta hezurgabetutako sahieski iberikoa bere zukuarekin";
	document.getElementById("meal15").textContent="5 motatako gaztak";
	document.getElementById("meal16").textContent="Marrubiak, labneh eta hibiskoak";
	document.getElementById("meal17").textContent="Eztia, mamia eta intxaurrak";
	document.getElementById("meal18").textContent="Errege-sagarrak erreta eta bainilla krema";
...
function transCas()
{
	...
	document.getElementById("meal1").textContent="Tartar en la vaca que ríe";
	document.getElementById("meal2").textContent="Gazpacho";
	document.getElementById("meal3").textContent="Pulga de lomo y brie";
	...
	document.getElementById("meal7").textContent="Maki Tempurizado de txangurro";
	...
	document.getElementById("meal10").textContent="Pimientos rellenos de txangurro";
	document.getElementById("meal11").textContent="Mejillón escabeche y puerro";
	document.getElementById("meal12").textContent="Ravioli de perdiz y hortalizas";
	document.getElementById("meal13").textContent="Rape, perejil y emulsión de su refrito";
	...
	document.getElementById("meal16").textContent="Fresas, labneh e hibiscus";
	document.getElementById("meal17").textContent="Miel mamia y nueces";
	document.getElementById("meal18").textContent="QReinetas asadas y crema de vainilla";
	document.getElementById("period_span").textContent = period_es;
