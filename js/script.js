...
function transEus(value)
{
	...
	document.getElementById("meal1").textContent="Foie, pikilloen gelarekin";
	document.getElementById("meal2").textContent="Gilda oliba";
	document.getElementById("meal3").textContent="Onddoak eta sardina ketua";
	...
	document.getElementById("meal10").textContent="Erdi erretako tomatearen entsalada";
	document.getElementById("meal11").textContent="Izkiratzarra, beurre blanc eta zitrikoak";
	document.getElementById("meal12").textContent="Haragi-bolak, haragi-zukutan";
	...
	document.getElementById("meal17").textContent="Kakao eta fruitu erreen lingotea";
	document.getElementById("meal18").textContent="Jogurta eta mangoa";
...
function transCas()
{
	...
	document.getElementById("meal1").textContent="Foie con gel de piquillos";
	document.getElementById("meal2").textContent="Aceituna de gilda";
	document.getElementById("meal3").textContent="Hongos y sardina ahumada";
	...
	document.getElementById("meal10").textContent="Ensalada de tomate semi-asado";
	document.getElementById("meal11").textContent="Carabinero, beurre blanc y cítricos";
	document.getElementById("meal12").textContent="Albóndigas con jugo de carne";
	...
	document.getElementById("meal17").textContent="Lingote de cacao y frutas asadas";
	document.getElementById("meal18").textContent="Yogurt y mango";
	document.getElementById("period_span").textContent = period_es;
