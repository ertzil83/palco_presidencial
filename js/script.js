...
function transEus(value)
{
	...
	document.getElementById("meal1").textContent="Hegaluze-arkakusoa maionesarekin";
	document.getElementById("meal2").textContent="Pikuak foiearekin";
	document.getElementById("meal3").textContent="Gilda oliba";
	document.getElementById("meal4").textContent="Bieira Nigiria";
	document.getElementById("meal5").textContent="Txuleta Nigiria";
	document.getElementById("meal6").textContent="Tenpurizatutako Makia";
	document.getElementById("meal7").textContent="Roll mokadua";
	...
	document.getElementById("meal10").textContent="Arrautza, onddoak eta oilo-salda";
	document.getElementById("meal11").textContent="Semola perretxikoekin eta demi-glace-ekin";
	document.getElementById("meal12").textContent="Legatza eta piper errearen zukua";
	document.getElementById("meal13").textContent="Ahate-terrina eta berenjena errea";
	//document.getElementById("meal14").textContent="Konfitatu eta hezurgabetutako sahieski iberikoa bere zukuarekin";
	document.getElementById("meal15").textContent="Gorringo txigortu eta glasatuzko bizkotxoa";
	document.getElementById("meal16").textContent="Txokolatea, almendra-pralinea eta kurruskaria";
	document.getElementById("meal17").textContent="Tapioka, esne-krema eta anana";
	document.getElementById("meal18").textContent="Askotariko gaztak";
...
function transCas()
{
	...
	document.getElementById("meal1").textContent="Pulga de bonito con mahonesa";
	document.getElementById("meal2").textContent="Higos con foie";
	document.getElementById("meal3").textContent="Gilda clásica";
	document.getElementById("meal4").textContent="Nigiri de vieira";
	document.getElementById("meal5").textContent="Nigiri txuleta";
	document.getElementById("meal6").textContent="Maki de Tempurizado";
	document.getElementById("meal7").textContent="Bokado Roll";
	...
	document.getElementById("meal10").textContent="Huevo, hongos y consomé de gallina";
	document.getElementById("meal11").textContent="Sémola con setas y demi-glace";
	document.getElementById("meal12").textContent="Merluza y jugo de pimiento asado";
	document.getElementById("meal13").textContent="Terrina de pato y berenjena asada";
	//document.getElementById("meal14").textContent="Costillar de ibérico confitado y deshuesado con su jugo";
	document.getElementById("meal15").textContent="Bizcocho de yema tostada y glaseado";
	document.getElementById("meal16").textContent="Chocolate, praliné de almendra y crujiente";
	document.getElementById("meal17").textContent="Tapioca, crema de leche y piña";
	document.getElementById("meal18").textContent="Quesos variados";
	document.getElementById("period_span").textContent = period_es;
