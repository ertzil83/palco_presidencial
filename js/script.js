...
function transEus(value)
{
	...
	document.getElementById("meal1").textContent="Saltxitxoi kukusoa";
	document.getElementById("meal2").textContent="Patata eta tipulazko tortilla";
	document.getElementById("meal3").textContent="Muskuiluzko kroketa";
	document.getElementById("meal4").textContent="Foie krema hostopilean";
	document.getElementById("meal5").textContent="Mini hanburgesa";
	document.getElementById("meal6").textContent="Pasta entsalada";
	document.getElementById("meal7").textContent="Eltzeko madrileñoaren zopa";
	document.getElementById("meal8").textContent="Izokin errea saltsa tartararekin";
	document.getElementById("meal9").textContent="Saiheski tako konfitatua, haragi-zukuarekin";
	document.getElementById("meal10").textContent="";
	document.getElementById("meal11").textContent="Txokolatezko pastela";
	document.getElementById("meal12").textContent="Askotariko gazta eta txokolateak";
	document.getElementById("meal13").textContent="Makarroi-gailetak";
...
function transCas()
{
	...
	document.getElementById("meal1").textContent="Pulga de salchichón";
	document.getElementById("meal2").textContent="Tortilla de patata y cebolla";
	document.getElementById("meal3").textContent="Croqueta de mejillón";
	document.getElementById("meal4").textContent="Crema de foie en hojaldre";
	document.getElementById("meal5").textContent="Mini hamburguesa";
	document.getElementById("meal6").textContent="Ensalada de pasta";
	document.getElementById("meal7").textContent="Sopa de cocido madrileño";
	document.getElementById("meal8").textContent="Salmón asado con salsa tártara";
	document.getElementById("meal9").textContent="Taco de costilla confitada con jugo de carne";
	document.getElementById("meal10").textContent="";
	document.getElementById("meal11").textContent="Pastel de chocolate";
	document.getElementById("meal12").textContent="Quesos y chocolatinas variadas";
	document.getElementById("meal13").textContent="Macarons";
	document.getElementById("period_span").textContent = period_es;
