...
function transEus(value)
{
	...
	document.getElementById("meal1").textContent="Urdaiazpiko kukusoa pan tumakarekin";
	document.getElementById("meal2").textContent="Lumagorri Bao ogia";
	document.getElementById("meal3").textContent="Foiea pikillo gelarekin";
	document.getElementById("meal4").textContent="Bieira nigiria";
	document.getElementById("meal5").textContent="Ganba nigiria";
	document.getElementById("meal6").textContent="Roll mokadua";
	document.getElementById("meal7").textContent="Oskol biguneko karramarro makia";
	document.getElementById("meal8").textContent="Joselito erreserba handiko urdaiazpikoa";
	document.getElementById("meal9").textContent="Joselito butifarra zuria, butifarra beltza eta txorizoa";
	document.getElementById("meal10").textContent="Bakailao esqueixada";
	document.getElementById("meal11").textContent="Zerba eta anakardoa";
	document.getElementById("meal12").textContent="Legatza txipiroi olioarekin";
	document.getElementById("meal13").textContent="Haragiz betetako piperrak";
	document.getElementById("meal14").textContent="Bildotsa letxuga eta tipuleta entsaladarekin";
	document.getElementById("meal15").textContent="Bost motatako gaztak";
	document.getElementById("meal16").textContent="Mini pantxinetak";
	document.getElementById("meal17").textContent="Tiramisua";
	document.getElementById("meal18").textContent="Anana erre euskal pastela";
...
function transCas()
{
	...
	document.getElementById("meal1").textContent="Pulga de jamón con pan tumaca";
	document.getElementById("meal2").textContent="Pan Bao de lumagorri";
	document.getElementById("meal3").textContent="Foie con gel de piquillos";
	document.getElementById("meal4").textContent="Nigiri Vieira";
	document.getElementById("meal5").textContent="Nigiri de gamba";
	document.getElementById("meal6").textContent="Bokado Roll";
	document.getElementById("meal7").textContent="Maki cangrejo de concha blanda";
	document.getElementById("meal8").textContent="Jamón gran reserva Joselito";
	document.getElementById("meal9").textContent="Butifarra blanca, butifarra negra y chorizo Joselito";
	document.getElementById("meal10").textContent="Esqueixada de bacalao";
	document.getElementById("meal11").textContent="Acelga y anacardo";
	document.getElementById("meal12").textContent="Merluza con aceite de txipirón";
	document.getElementById("meal13").textContent="Pimientos rellenos de carne";
	document.getElementById("meal14").textContent="Cordero con ensalada de lechuga y cebolleta";
	document.getElementById("meal15").textContent="Queso 5 variedades";
	document.getElementById("meal16").textContent="Mini pantxinetas";
	document.getElementById("meal17").textContent="Tiramisú";
	document.getElementById("meal18").textContent="Gateau basque de piña asada";
	document.getElementById("period_span").textContent = period_es;
