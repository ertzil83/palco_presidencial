...
function transEus(value)
{
	...
	document.getElementById("meal1").textContent="Solomo eta brie karamelua";
	document.getElementById("meal2").textContent="Donostiar erako txangurroaren hostorea";
	document.getElementById("meal3").textContent="Saltxitxoi kukusoa";
	document.getElementById("meal4").textContent="Izokin nigiria";
	document.getElementById("meal5").textContent="Txuleta nigiria";
	document.getElementById("meal6").textContent="Txipiroi makia bere tintan";
	...
	document.getElementById("meal10").textContent="Pistoa arrautzarekin, tenperatura baxuan";
	document.getElementById("meal11").textContent="Izkiratzar arroza";
	document.getElementById("meal12").textContent="Zapo errea molusku zukuarekin";
	document.getElementById("meal13").textContent="Haragi bolak foie saltsarekin";
	document.getElementById("meal14").textContent="Ahatea alberjinia errearekin";
	document.getElementById("meal15").textContent="Bost motatako gaztak";
	document.getElementById("meal16").textContent="Arrozesnea eta mangoa";
	document.getElementById("meal17").textContent="Laranja lore eta banilla natillak";
	document.getElementById("meal18").textContent="Ogi torradak hur txigortuarekin";
...
function transCas()
{
	...
	document.getElementById("meal1").textContent="Caramelo de lomo y brie";
	document.getElementById("meal2").textContent="Hojaldre de txangurro a la Donostiarra";
	document.getElementById("meal3").textContent="Pulga de salchichon";
	document.getElementById("meal4").textContent="Nigiri salmón";
	document.getElementById("meal5").textContent="Nigiri de txuleta";
	document.getElementById("meal6").textContent="Maki txipirón en su tinta";
	...
	document.getElementById("meal10").textContent="Pisto con huevo a baja";
	document.getElementById("meal11").textContent="Arroz de carabinero";
	document.getElementById("meal12").textContent="Rape asado y jugo de moluscos";
	document.getElementById("meal13").textContent="Albóndigas con salsa de foie";
	document.getElementById("meal14").textContent="Pato con berenjena asada";
	...
	document.getElementById("meal17").textContent="Natillas de azahar y vainilla";
	document.getElementById("meal18").textContent="Torrijas con avellana tostada";
	document.getElementById("period_span").textContent = period_es;
