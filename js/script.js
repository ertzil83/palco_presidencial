...
function transEus(value)
{
	...
	document.getElementById("meal1").textContent="Eskalibada opila";
	document.getElementById("meal2").textContent="Foiea sagar erre purearekin";
	document.getElementById("meal3").textContent="Hegaluze kukusoa tomatearekin eta piperrekin";
	document.getElementById("meal4").textContent="Askotariko sushia";
	document.getElementById("meal5").textContent="Joselito erreserba handiko urdaiazpikoa";
	document.getElementById("meal6").textContent="Joselito txorizoa";
	document.getElementById("meal7").textContent="Askotariko enpanadak";
	...
	document.getElementById("meal10").textContent="Arrain suqueta";
	document.getElementById("meal11").textContent="Orburuak txirla saltsarekin";
	document.getElementById("meal12").textContent="Arrautza baxuan, piper salda eta arroz fideoekin";
	document.getElementById("meal13").textContent="Zapoa modu tradizionalean";
	document.getElementById("meal14").textContent="Lumagorria bere zuku tomateztatuan";
	document.getElementById("meal15").textContent="Bost motatako gaztak";
	document.getElementById("meal16").textContent="Gofrea txokolatearekin";
	document.getElementById("meal17").textContent="Ensaimada";
	document.getElementById("meal18").textContent="Melokotoia eta jogurta";
...
function transCas()
{
	...
	document.getElementById("meal1").textContent="Coca de escalivada";
	document.getElementById("meal2").textContent="Foie con Puré de manzana asada";
	document.getElementById("meal3").textContent="Pulga de bonito con mahonesa y piparras";
	document.getElementById("meal4").textContent="Sushi variado";
	document.getElementById("meal5").textContent="Jamón gran reserva Joselito";
	document.getElementById("meal6").textContent="Chorizo Joselito";
	document.getElementById("meal7").textContent="Empanadas variadas";
	//document.getElementById("meal8").textContent="Jamón gran reserva Joselito";
	//sdocument.getElementById("meal9").textContent="Lomo, salchichón y chorizo Joselito";
	document.getElementById("meal10").textContent="Suquet de pescado";
	document.getElementById("meal11").textContent="Alcachofas con salsa de almejas";
	document.getElementById("meal12").textContent="Huevo a baja, con caldo de pimientos y fideos de arroz";
	document.getElementById("meal13").textContent="Rape estilo tradicional";
	document.getElementById("meal14").textContent="Lumagorri en su jugo atomatado";
	document.getElementById("meal15").textContent="Queso 5 variedades";
	document.getElementById("meal16").textContent="Gofre con chocolate";
	document.getElementById("meal17").textContent="Ensaimada";
	document.getElementById("meal18").textContent="Melocotón y yogurt";
	document.getElementById("period_span").textContent = period_es;
