...
function transEus(value)
{
	...
	document.getElementById("meal1").textContent="Patata tortilla kukusoa";
	document.getElementById("meal2").textContent="Urdaiazpiko kroketa";
	document.getElementById("meal3").textContent="Txitxarroa eta sagarra";
	...
	document.getElementById("meal10").textContent="Izokin fresko konfitatuzko lasagna";
	document.getElementById("meal11").textContent="Bakailaoa piper berdearekin";
	document.getElementById("meal12").textContent="Txipiroi marmitakoa";
	document.getElementById("meal13").textContent="Arroz fideoak ahate konfitatuarekin";
	document.getElementById("meal14").textContent="Topinambour eta kafe azpizuna";
	document.getElementById("meal15").textContent="Bost motatako gazta";
	document.getElementById("meal16").textContent="Txokolatezko bizkotxoa";
	document.getElementById("meal17").textContent="Jogurta eta mangoa";
	document.getElementById("meal18").textContent="Kakao eta fruitu erreen lingotea";
...
function transCas()
{
	...
	document.getElementById("meal1").textContent="Pulga de tortilla patata";
	document.getElementById("meal2").textContent="Croqueta de jamón";
	document.getElementById("meal3").textContent="Txitxarro y manzana";
	...
	document.getElementById("meal10").textContent="Lasagna de salmón fresco confitado";
	document.getElementById("meal11").textContent="Bacalao con pimiento verde";
	document.getElementById("meal12").textContent="Marmitako de calamar";
	document.getElementById("meal13").textContent="Fideos de arroz con pato confitado";
	...
	document.getElementById("meal16").textContent="Bizcocho de Chocolate";
	document.getElementById("meal17").textContent="Yogurt y mango";
	document.getElementById("meal18").textContent="Lingote de cacao y frutas asadas";
	document.getElementById("period_span").textContent = period_es;
