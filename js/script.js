...
function transEus(value)
{
	...
	document.getElementById("meal2").textContent="Pasealeku berriko arkaitzak";
	document.getElementById("meal3").textContent="Patata ia mina";
	...
	document.getElementById("meal10").textContent="Izkiratzar arroza";
	document.getElementById("meal11").textContent="Arrautza, onddoa eta oilo kontsomea";
	...
	document.getElementById("meal16").textContent="Sagar errea";
	document.getElementById("meal17").textContent="Frutadun jogurta";
...
function transCas()
{
	...
	document.getElementById("meal3").textContent="Patata casi brava";
	...
	document.getElementById("meal10").textContent="Arroz de carabinero";
	document.getElementById("meal11").textContent="Huevo, hongo y consomé de gallina";
	...
	document.getElementById("meal16").textContent="Manzada asada";
	document.getElementById("meal17").textContent="Yogurt de frutas";
