...
function transEus(value)
{
	...
	document.getElementById("meal1").textContent="Fruitu lehorrak eta txokolatea pikatosteekin";
	document.getElementById("meal2").textContent="Macaron-ak, donuts eta patatas frijituak";
	document.getElementById("meal3").textContent="Kopa iberikoko arkakusoa";
	document.getElementById("meal4").textContent="Antxoa-gilda tradizionala";
	document.getElementById("meal5").textContent="Arrain-pastela";
	document.getElementById("meal6").textContent="Askotariko hestebeteak";
	document.getElementById("meal7").textContent="Sushia";
	document.getElementById("meal8").textContent="Hegazti-kroketa";
	document.getElementById("meal9").textContent="Txistorra-taloa eta patata errea";
	document.getElementById("meal10").textContent="Foie-a sagar-purearekin";
	document.getElementById("meal11").textContent="Goxua";
	document.getElementById("meal12").textContent="Minipantxinetak";
	document.getElementById("meal13").textContent="Askotariko bizkotxo eta gaztak";
...
function transCas()
{
	...
	document.getElementById("meal1").textContent="Frutos secos y chocolate con picatostes";
	document.getElementById("meal2").textContent="Macarons, donuts y patatas fritas";
	document.getElementById("meal3").textContent="Pulga de copa ibérica";
	document.getElementById("meal4").textContent="Gilda tradicional de anchoa";
	document.getElementById("meal5").textContent="Pastel de pescado";
	document.getElementById("meal6").textContent="Embutido variado";
	document.getElementById("meal7").textContent="Sushi";
	document.getElementById("meal8").textContent="Croqueta de ave";
	document.getElementById("meal9").textContent="Talo de txistorra y patata asada";
	document.getElementById("meal10").textContent="Foie con puré de manzana";
	document.getElementById("meal11").textContent="Goxua";
	document.getElementById("meal12").textContent="Minipantxinetas";
	document.getElementById("meal13").textContent="Bizcochos y quesos variados";
	document.getElementById("period_span").textContent = period_es;
