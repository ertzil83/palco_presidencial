...
function transEus(value)
{
	...
	document.getElementById("meal1").textContent="Urdaiazpikozko kroketa";
	document.getElementById("meal2").textContent="Txangurro entsaladillaren vol au venta";
	document.getElementById("meal3").textContent="Ehizako hegaztiaren eclairea";
	...
	document.getElementById("meal10").textContent="Kardu konfitatua eta pistatxoa";
	document.getElementById("meal11").textContent="Arrautza, onddoa eta oilo kontsomea";
	document.getElementById("meal12").textContent="Izkiratzarra, beurre blanc eta zitrikoak";
	document.getElementById("meal13").textContent="Bildotsa eta piper konfitatuak";
	...
	document.getElementById("meal16").textContent="Askotariko turroiak";
...
function transCas()
{
	...
	document.getElementById("meal2").textContent="Vol au vent de ensaladilla de txangurro";
	document.getElementById("meal3").textContent="Eclaire de ave de caza";
	...
	document.getElementById("meal10").textContent="Cardo confitado y pistacho";
	document.getElementById("meal11").textContent="Huevo, hongo y consomé de gallina";
	document.getElementById("meal12").textContent="Carabinero, beurre blanc y cítricos";
	document.getElementById("meal13").textContent="Cordero y pimientos confitados";
	...
	document.getElementById("meal16").textContent="Turrones variados";
