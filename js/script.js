...
function transEus(value)
{
	...
	document.getElementById("meal1").textContent="Hegaluze minia tomatearekin eta piperrekin";
	document.getElementById("meal2").textContent="Arrain pastela";
	document.getElementById("meal3").textContent="Odolki kroketa";
	document.getElementById("meal4").textContent="Izokin nigiria";
	document.getElementById("meal5").textContent="Berdel nigiria";
	document.getElementById("meal6").textContent="Askotariko makiak";
	document.getElementById("meal7").textContent="Joselito erreserba handiko urdaiazpikoa";
	document.getElementById("meal8").textContent="Joselito solomoa, saltxitxoia eta txorizoa";
	//document.getElementById("meal9").textContent="Joselito solomoa, saltxitxoia eta txorizoa";
	document.getElementById("meal10").textContent="Txahal masailak bere zukuan";
	document.getElementById("meal11").textContent="Zainzuri naturalak anakardo kremarekin";
	document.getElementById("meal12").textContent="Txangurrua eta kalabaza errea";
	document.getElementById("meal13").textContent="Legatza saltsa berdean";
	document.getElementById("meal14").textContent="Txuleta errea";
	document.getElementById("meal15").textContent="Bost motatako gaztak";
	document.getElementById("meal16").textContent="Pantxineta";
	document.getElementById("meal17").textContent="Mamia eztiarekin";
	document.getElementById("meal18").textContent="Laranja eta laranja-lore zopa";
...
function transCas()
{
	...
	document.getElementById("meal1").textContent="Mini de bonito con mahonesa y piparras";
	document.getElementById("meal2").textContent="Pastel de pescado";
	document.getElementById("meal3").textContent="Croqueta de morcilla";
	document.getElementById("meal4").textContent="Nigiri salmón";
	document.getElementById("meal5").textContent="Nigiri de verdel";
	document.getElementById("meal6").textContent="Makis variados";
	document.getElementById("meal7").textContent="Jamón gran reserva Joselito";
	document.getElementById("meal8").textContent="Lomo, salchichón y chorizo Joselito";
	//document.getElementById("meal9").textContent="Lomo, salchichón y chorizo Joselito";
	document.getElementById("meal10").textContent="Carrilleras en su jugo";
	document.getElementById("meal11").textContent="Espárragos naturales con crema de anacardos";
	document.getElementById("meal12").textContent="Txangurro y calabaza asada";
	document.getElementById("meal13").textContent="Merluza en salsa verde";
	document.getElementById("meal14").textContent="Txuleta asada ";
	document.getElementById("meal15").textContent="Queso 5 variedades";
	document.getElementById("meal16").textContent="Panchineta";
	document.getElementById("meal17").textContent="Mamia con miel";
	document.getElementById("meal18").textContent="Sopa de naranja y azahar";
	document.getElementById("period_span").textContent = period_es;
