...
function transEus(value)
{
	...
	document.getElementById("meal2").textContent="Ganben entsaladilla errusiarraren vol au vent-a";
	document.getElementById("meal3").textContent="Langostinoak gabardinarekin";
	document.getElementById("meal4").textContent="Txuleta nigiria";
	document.getElementById("meal5").textContent="Bieira makia Idiazabal gaztarekin";
	document.getElementById("meal6").textContent="Gyozak";
	...
	document.getElementById("meal11").textContent="Pistoa bakailaoarekin";
	document.getElementById("meal12").textContent="Txangurroa donostiar erara";
	document.getElementById("meal13").textContent="Legatz arrautzeztatua eta piper errearen zukua";
	document.getElementById("meal14").textContent="Usakume errea patata pure krematsuarekin";
	document.getElementById("meal15").textContent="Bost motatako gazta";
	document.getElementById("meal16").textContent="Apple Pie";
	document.getElementById("meal17").textContent="Azenario tarta";
	document.getElementById("meal18").textContent="Arrozesnea";
...
function transCas()
{
	...
	document.getElementById("meal2").textContent="Vol au vent de ensaladilla rusa de gambas";
	document.getElementById("meal3").textContent="Langostinos con gabardina";
	document.getElementById("meal4").textContent="Niguiri de chuleta";
	document.getElementById("meal5").textContent="Maki de vieira con Idiazabal";
	document.getElementById("meal6").textContent="Gyozas";
	...
	document.getElementById("meal11").textContent="Pisto con bacalao";
	document.getElementById("meal12").textContent="Txangurro a la Donostiarra";
	document.getElementById("meal13").textContent="Merluza rebozada y jugo de pimiento asado";
	document.getElementById("meal14").textContent="Pichón asado con pure cremoso de patata";
	document.getElementById("meal15").textContent="Queso 5 variedades";
	document.getElementById("meal16").textContent="Apple Pie";
	document.getElementById("meal17").textContent="Carrot cake";
	document.getElementById("meal18").textContent="Arroz con leche";
	document.getElementById("period_span").textContent = period_es;
