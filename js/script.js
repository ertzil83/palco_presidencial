...
function transEus(value)
{
	...
	document.getElementById("meal1").textContent="Txistorra kukusoa";
	document.getElementById("meal2").textContent="Urdaiazpiko eta gaztadun croissanta";
	document.getElementById("meal3").textContent="Pasealeku berriko harkaitza";
	...
	document.getElementById("meal10").textContent="Kardua urdaiazpikoarekin";
	document.getElementById("meal11").textContent="Potxak nafar erara";
	document.getElementById("meal12").textContent="Zapoa modu tradizionalean";
	document.getElementById("meal13").textContent="Buztanez betetako piperrak";
	...
	document.getElementById("meal18").textContent="Sagar tarta";
...
function transCas()
{
	...
	document.getElementById("meal1").textContent="Pulga de txistorra";
	document.getElementById("meal2").textContent="Croisant de jamón y queso";
	document.getElementById("meal3").textContent="Roca del Paseo Nuevo";
	...
	document.getElementById("meal10").textContent="Cardo con jamón";
	document.getElementById("meal11").textContent="Pochas a la Navarra";
	document.getElementById("meal12").textContent="Rape estilo tradicional";
	document.getElementById("meal13").textContent="Pimientos rellenos de rabo";
	...
	document.getElementById("meal16").textContent="Melocotón y yogur";
	document.getElementById("meal17").textContent="Tiramisú";
	document.getElementById("meal18").textContent="Tarta de manzana";
	document.getElementById("period_span").textContent = period_es;
